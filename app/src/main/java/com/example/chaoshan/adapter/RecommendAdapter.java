...
public class RecommendAdapter extends ArrayAdapter<Hotel> {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        //为每一个子项加载设定的布局
        View view = LayoutInflater.from(getContext()).inflate(R.layout.recommend_item, parent, false);
        ...
        // 设置要显示的图片和文字
        if (hotel != null){
            //Glide.with(getContext()).load(hotel.getImgSrc()).into(image);
